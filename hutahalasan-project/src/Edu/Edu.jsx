  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta
          name="description"
          content="Perdalam pengetahuan dengan belajar tentang moralitas dan nilai-nilai kehidupan dalam Ugamo Malim."
        />
      </Helmet>
      <Header />
      ...
      <div className="k-container">
        ...
        <div
          style={{ borderTop: "1.5px solid var(--k-border)", paddingTop: 1 }}
        >
              ...
              {loading ? (
                ...
                <div style={{ marginTop: 24 }}>
                  ...
                  <div
                    ...
                    onKeyDown={(e) =>
                      e.key === "Enter" &&
                      navigate(`/education/${featured.id_konten}`)
                    }
                  >
              ...
              <div style={{ marginTop: 24 }}>
                ...
                <div className="k-card-grid">
                  {loading
                    ...
                    : (activeTab === "trending" ? trending : rest).map(
                        (item) => (
                          <div
                            key={item.id_konten}
                            className="k-card"
                            onClick={() =>
                              navigate(`/education/${item.id_konten}`)
                            }
                            role="button"
                            tabIndex={0}
                            onKeyDown={(e) =>

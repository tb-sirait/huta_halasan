      ...
      {canViewInsight && (
        <div className="dashboard-stats">
          {[
            {
              icon: "👁",
              cls: "dashboard-stat-icon-view",
              label: "Total Views",
              val: formatNumber(stats.views),
            },
            {
              icon: "❤️",
              cls: "dashboard-stat-icon-like",
              label: "Total Likes",
              val: formatNumber(stats.likes),
            },
            {
              icon: "💬",
              cls: "dashboard-stat-icon-komen",
              label: "Total Komentar",
              val: formatNumber(stats.komentar),
            },
            {
              icon: "📄",
              cls: "dashboard-stat-icon-konten",
              label: "Total Konten",
              val: formatNumber(stats.konten),
            },

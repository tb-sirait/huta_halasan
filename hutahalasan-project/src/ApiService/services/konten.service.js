...
const KontenService = {
  ...
  create: async ({ judul, penulis, isi_konten, jenis_konten, tagline, gambar = [] }) => {
  ...
  update: async (id_konten, { judul, penulis, isi_konten, jenis_konten, tagline }) => {
    const body = {};
  ...
  updateValidasi: async (id_konten, status_validasi) => {
    return await api.patch(`/konten/${id_konten}/validasi`, { status_validasi });
